...
//afin de respecter les contraintes de clés étrangères : Quel est l'ordre à adopter ? Argumenter.

// 1/ mise en ordre des tables vide simplifié.
...
// 2/ explication de la mise en ordre des tables.

// dans un premier temps on indique les tables (countries et posts) car il n'y a pas de clé étrangère, le programme ne les reliera pas avec les autres tables.
// ensuite la table customer, products, orders_details, orders, employees, suppliers.
